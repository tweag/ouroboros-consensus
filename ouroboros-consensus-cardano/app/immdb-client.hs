...
import Ouroboros.Consensus.Node.NetworkProtocolVersion
  ...
  , SupportedNetworkProtocolVersion (supportedNodeToNodeVersions)
  )
...
demoProtocol2 chainSync =
 ...
 where
  limits = chainSyncProtocolLimits defaultMiniProtocolParameters
...
clientChainSync sockAddr codecCfg networkMagic maxSlotNo = withIOManager $ \iocp ->
 ...
 where
  ...
  getCodec version blockVersion =
    Consensus.N2N.cChainSyncCodecSerialised $
